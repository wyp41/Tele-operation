...
public class HttpReader : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            reading = false;
            var readPath = Application.dataPath + "/Plugins/" + (started).ToString() + ".ply";
            //print(readPath);
    ...
    {
        string url = "http://172.17.1.103:5000/uploads/" + num.ToString() + ".ply";
        //print(url);
        ...
        if (downloadTask.Exception == null)
        {
            ...
            filePath = Application.dataPath + "/Plugins/" + num.ToString() + ".ply";
            //print(filePath);
